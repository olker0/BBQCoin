...
public:
    CMainParams() {
     ...
     //   vSeeds.push_back(CDNSSeedData("bbqcointools.com", "dnsseed.bbqcointools.com"));
        ...
        vSeeds.push_back(CDNSSeedData("185.25.60.199", "185.25.60.199"));
        vSeeds.push_back(CDNSSeedData("188.186.96.174", "188.186.96.174"));

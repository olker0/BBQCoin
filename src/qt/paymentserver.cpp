...
const char* BIP71_MIMETYPE_PAYMENT = "application/bbqcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/bbqcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/bbqcoin-paymentrequest";
